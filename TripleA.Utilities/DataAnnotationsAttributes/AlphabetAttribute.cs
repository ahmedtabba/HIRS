...
namespace TripleA.Utility.DataAnnotationsAttributes
{
    ...
    public class AlphabetAttribute : RegularExpressionAttribute, IClientValidatable
    {
        private const string _alphanumericPatternFormat = @"[a-zA-Zء-ي\s{0}]*";
        private char[] _allowedChars;
        public AlphabetAttribute(params char[] allowedChars)
        ...
        protected string GetValidationErrorMessage(char[] allowedChars)
        {
            ...
            {
                return AnnotationMessages.Alphabets;
            }
            else
            {
                ...
                return string.Format(AnnotationMessages.AlphabetsAnd, allowedCharsBuilder.ToString());
            }
        }
