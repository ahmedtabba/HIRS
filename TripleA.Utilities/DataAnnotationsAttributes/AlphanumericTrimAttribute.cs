...
namespace TripleA.Utility.DataAnnotationsAttributes
{
    ...
    public class AlphanumericTrimAttribute: RegularExpressionAttribute, IClientValidatable
    {
        private const string _alphanumericPatternFormat = @"^[a-zA-Zء-ي][a-zA-Zء-ي\d{0}]*";
        private char[] _allowedChars;
        public AlphanumericTrimAttribute(params char[] allowedChars)
        ...
        protected string GetValidationErrorMessage(char[] allowedChars)
        {
            ...
            {
                return AnnotationMessages.AlphanumericTrim;
            }
            else
            {
                ...
                return string.Format(AnnotationMessages.AlphanumericAndTrim , allowedCharsBuilder.ToString());
            }
        }
