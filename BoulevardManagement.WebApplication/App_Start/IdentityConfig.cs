...
namespace BoulevardManagement.WebApplication
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static List<UserNotificationGroup> GetUserNotificationGroups(string userId)
        {
            using (ApplicationDbContext context = new ApplicationDbContext())
            {
                var ss = context.UserNotificationGroups.ToList();
                var ss1 = context.Users.ToList();
                return context.UserNotificationGroups.Where(c => c.ApplicationUserId == userId).ToList();
            }
        }
